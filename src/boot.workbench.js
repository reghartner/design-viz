...
var CONTRACT = [
  ...
  '- Optional diagram.layouts: [{id,name,sectionLayout}] provides multiple named',
  '  arrangements sharing the same steps, paths and panels; defaultLayout picks',
  ...
  '  controls:"steps" identifies movable playback/path/caption controls; omit both',
