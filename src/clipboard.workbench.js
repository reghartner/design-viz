...
function initBuilderClipboard(document, options){
  var life=createWorkbenchLifetime();
  ...
  life.listen(document.getElementById('object-copy'),'click',function(){copy();});
  life.listen(document.getElementById('object-duplicate'),'click',function(){duplicate();});
  life.listen(document.getElementById('object-paste'),'click',function(){open();});
  life.listen(document.getElementById('object-clipboard-cancel'),'click',close);
  life.listen(document.getElementById('object-clipboard-apply'),'click',function(){
  ...
  life.listen(input,'input',function(){request++;});
  life.listen(dialog,'cancel',function(ev){ev.preventDefault();close();});
  life.listen(dialog,'keydown',function(ev){if(ev.key==='Escape')ev.stopPropagation();});
  life.listen(document,'copy',function(ev){
  ...
  life.listen(document,'paste',function(ev){
    if(options.isActive && !options.isActive())return;
