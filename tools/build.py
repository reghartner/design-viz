...
WORKBENCH_TEMPLATES = [
    ...
    {"name": "Doorbell domain drilldowns", "desc": "Explore connectivity and recording domains, expand their components, and follow failures into nested detail flows.", "category": "engineering", "categories": ["devices"], "tag": "Drill down & expand", "art": "layers", "source": "starters/domain-drilldown.json"},
