...
var ICON_SET = FlowIcons.ids.slice();
...
function validateSection(sec, P, protos, lanes, errors, warnings){
  ...
  FlowBrand.warnings(d.brand, DP + ".brand", warnings);
  var panelIds = {};
  var panelDeclById = {};
  ...
  (d.panels || []).forEach(function(p, pi){
    ...
    FlowBrand.warnings(p.brand, PP + ".brand", warnings);
...
/* ---- src/panels/types/appscreens.js ---- */
